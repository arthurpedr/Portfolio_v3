...
const Timeline = ({ items = [] }) => {
  ...
  // Variantes para a linha da timeline
  const lineVariants = {
    hidden: {
      scaleY: 0
    },
  ...
  return (
    <div className="relative w-full h-full" ref={containerRef}>
      ...
      <motion.div 
        className="absolute left-2 top-0 h-full w-0.5 bg-gray-200 rounded-full origin-top"
      ...
      <motion.ol 
        className="space-y-20 w-full h-full"
                        ...
                        {item.images.slice(0, 4).map((image, imgIndex) => (
                          ...
                          >
                            <motion.img 
                              ...
                              className="w-full h-24 rounded-lg shadow-md object-cover"
                              whileHover={{ 
                                scale: 1.05,
